...
local NEXT_UNASSIGNED_STYLE_ID = 151
local ICON_SIZE = "100%"
...
local styleCategories = {
    ...
    {
        label = GetFormattedCategoryName(10475), -- "Necrom"
        values = {
            140, -- Scribes of Mora
    ...
    {
        label = GetFormattedCategoryName(11871), -- "Gold Road"
        values = {
            145, -- The Recollection
            146, -- Blind Path Cultist
            147, -- Shardborn
            148, -- West Weald Legion
            149, -- Lucent Sentinel
        },
    },
    {
