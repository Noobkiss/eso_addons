...
local integrityCheckList = {
    ...
    ["history/MailInvoice.lua"] = function() return AGS.class.MailInvoice ~= nil end,
    ["history/MailBox.lua"] = function() return AGS.internal.InitializeAugmentedMails ~= nil end,
    ["pc/guildselector/HiredTraderTooltip.lua"] = function() return AGS.class.HiredTraderTooltip ~= nil end,
    ["pc/guildselector/GuildSelector.lua"] = function() return AGS.class.GuildSelector ~= nil end,
    ["pc/guildselector/GuildSelector.xml"] = function() return AwesomeGuildStoreGuildSelectorTemplateLoaded ~= nil end,
    ...
    ["pc/frontend/ActivityWindow.xml"] = function() return AwesomeGuildStoreActivityWindow ~= nil end,
    ["pc/frontend/ActivityWindow.lua"] = function() return AGS.class.ActivityWindow ~= nil end,
    ["pc/frontend/StatusLine.xml"] = function() return AwesomeGuildStoreActivityStatusLineTemplateLoaded ~= nil end,
    ["pc/frontend/StatusLine.lua"] = function() return AGS.class.StatusLine ~= nil end,
    ...
    ["pc/frontend/SearchList.xml"] = function() return AwesomeGuildStoreSearchListContainer ~= nil end,
    ["pc/frontend/SearchList.lua"] = function() return AGS.class.SearchList ~= nil end,
    ["pc/frontend/SearchResultListWrapper.lua"] = function() return AGS.class.SearchResultListWrapper ~= nil end,
    ["pc/frontend/CategorySelector.xml"] = function() return AwesomeGuildStoreCategorySelectorTemplateLoaded ~= nil end,
    ["pc/frontend/CategorySelector.lua"] = function() return AGS.class.CategorySelector ~= nil end,
    ["pc/frontend/FilterFragment.xml"] = function() return AwesomeGuildStoreFilterFragmentTemplateLoaded ~= nil end,
    ["pc/frontend/FilterFragment.lua"] = function() return AGS.class.FilterFragment ~= nil end,
    ["pc/frontend/FilterArea.lua"] = function() return AGS.class.FilterArea ~= nil end,
    ["pc/frontend/filter/ValueRangeFilterFragmentBase.lua"] = function()
        return AGS.class.ValueRangeFilterFragmentBase ~= nil
    end,
    ["pc/frontend/filter/PriceRangeFilterFragment.xml"] = function()
        return AwesomeGuildStorePriceInputTemplateLoaded ~= nil
    end,
    ["pc/frontend/filter/PriceRangeFilterFragment.lua"] = function() return AGS.class.PriceRangeFilterFragment ~= nil end,
    ["pc/frontend/filter/LevelRangeFilterFragment.xml"] = function()
        return AwesomeGuildStoreLevelInputTemplateLoaded ~= nil
    end,
    ["pc/frontend/filter/LevelRangeFilterFragment.lua"] = function() return AGS.class.LevelRangeFilterFragment ~= nil end,
    ["pc/frontend/filter/QualityFilterFragment.lua"] = function() return AGS.class.QualityFilterFragment ~= nil end,
    ["pc/frontend/filter/TextFilterFragment.xml"] = function()
        return AwesomeGuildStoreTextSearchInputTemplateLoaded ~= nil
    end,
    ["pc/frontend/filter/TextFilterFragment.lua"] = function() return AGS.class.TextFilterFragment ~= nil end,
    ["pc/frontend/filter/MultiCategoryFilterFragment.xml"] = function()
        return AwesomeGuildStoreMultiCategoryFilterRowTemplateLoaded ~= nil
    end,
    ["pc/frontend/filter/MultiCategoryFilterFragment.lua"] = function()
        return AGS.class.MultiCategoryFilterFragment ~= nil
    end,
    ["pc/frontend/filter/MultiButtonFilterFragment.lua"] = function() return AGS.class.MultiButtonFilterFragment ~= nil end,
    ["pc/frontend/filter/SortFilterFragment.lua"] = function() return AGS.class.SortFilterFragment ~= nil end,
    ["pc/wrappers/TradingHouseWrapper.lua"] = function() return AGS.class.TradingHouseWrapper ~= nil end,
    ["pc/wrappers/SearchTabWrapper.lua"] = function() return AGS.class.SearchTabWrapper ~= nil end,
    ["pc/wrappers/SellTabWrapper.lua"] = function() return AGS.class.SellTabWrapper ~= nil end,
    ["pc/wrappers/ListingTabWrapper.lua"] = function() return AGS.class.ListingTabWrapper ~= nil end,
    ["pc/wrappers/KeybindStripWrapper.lua"] = function() return AGS.class.KeybindStripWrapper ~= nil end,
    ["pc/guildstorelist/KioskData.lua"] = function() return AGS.class.KioskData ~= nil end,
    ["pc/guildstorelist/StoreData.lua"] = function() return AGS.class.StoreData ~= nil end,
    ["pc/guildstorelist/KioskList.lua"] = function() return AGS.class.KioskList ~= nil end,
    ["pc/guildstorelist/StoreList.lua"] = function() return AGS.class.StoreList ~= nil end,
    ["pc/guildstorelist/OwnerList.lua"] = function() return AGS.class.OwnerList ~= nil end,
    ["pc/guildstorelist/StoreLocationHelper.lua"] = function() return AGS.class.StoreLocationHelper ~= nil end,
    ["pc/guildstorelist/GuildStoreList.xml"] = function() return AGS.class.OwnerList ~= nil end,
    ["pc/guildstorelist/GuildList.xml"] = function() return AwesomeGuildStoreGuildTraders ~= nil end,
    ["pc/guildstorelist/TraderListControl.lua"] = function() return AGS.class.TraderListControl ~= nil end,
    ["pc/guildstorelist/GuildListControl.lua"] = function() return AGS.class.GuildListControl ~= nil end,
    ["pc/guildstorelist/OwnerHistoryControl.lua"] = function() return AGS.class.OwnerHistoryControl ~= nil end,
    ["pc/guildstorelist/KioskHistoryControl.lua"] = function() return AGS.class.KioskHistoryControl ~= nil end,
    ["pc/guildstorelist/GuildList.lua"] = function() return AGS.internal.InitializeGuildList ~= nil end,
    ["pc/guildstorelist/GuildStoreList.lua"] = function() return AGS.internal.InitializeGuildStoreList ~= nil end,
    ["pc/AwesomeGuildStore.xml"] = function() return AwesomeGuildStoreXmlLoaded ~= nil end,
...
local function ShouldCheck(fileName, isConsole)
    if isConsole and fileName:sub(1, 3) == "pc/" then
        return false
    end
    return true
end

local function IntegrityCheck(isConsole)
    ...
    for fileName, check in pairs(integrityCheckList) do
        if ShouldCheck(fileName, isConsole) then
            if not check() then
...
OnAddonLoaded(function()
    ...
    if (not IntegrityCheck(isConsole)) then return end

    local saveData = AGS.internal.LoadSettings()

    if isConsole then
        AGS.internal.InitializeConsolePlaceholder()
        return
    end
