...
WritWorthy.I18N["static"]["fr"] = {
  ...
  ["header_HaveCt"] = "Avoir",
  ["header_BuyCt"] = "acheter",
  ["header_PriceEa"] = "Prix",
  ["header_BuySubtotal"] = "Total",
  ["header_tooltip_RequiredCt"] = "Combien requis pour les commandes?",
  ["header_tooltip_HaveCt"] = "Combien dans l'inventaire + banque + sac d'artisanat?",
  ["header_tooltip_BuyCt"] = "Vous n'en avez pas assez ? De combien de plus avez-vous besoin ? (=Requis - Avoir)",
  ["header_tooltip_PriceEa"] = "Prix ​​par matériau",
  ["header_tooltip_BuySubtotal"] = "Prix ​​total (=Acheter × Prix)",
