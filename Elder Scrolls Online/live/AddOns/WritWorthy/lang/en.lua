...
WritWorthy.I18N["static"]["en"] = {
  ...
  ["lam_mm_fallback_desc"] = "If LibPrice cannot get a price from MM/ATT/TTC for some materials:\n* use 15g for basic style materials such as Molybdenum\n* use 5g for common trait materials such as Quartz.",
  ["lam_mm_fallback_title"] = "Fallback to hardcoded prices if no LibPrice data",
